<?php
  ...
  $title = "Полный каталог книг";
    require_once "./template/header.php";
?>


<h1 class="display-1 text-center">ПОЛНЫЙ КАТАЛОГ КНИГ</h1>
<h1 class="display-6">Отсортировать по:</h1>
...
<form method="post" action="books.php">
  ...
  <button type="submit" class="btn btn-secondary" name="title">Заголовок</button>
  <button type="submit" class="btn btn-secondary" name="price">Цена</button>
  <button type="submit" class="btn btn-secondary" name="author">Автор</button>
          ...
          <div class="col-md-3">
            <a href="book.php?bookisbn=<?php echo $query_row['book_isbn']; ?>">
              ...
              <table>
                ...
                <tr>
                <td><strong><?php echo $query_row['book_price'];?> руб.</strong>  </td>
                </tr>
              </table>
            </div>
        <?php
